...
internal static class FunctionQueries
{
...
internal sealed class FunctionRow
{
...
internal sealed class FunctionParamRow
{
    public int object_id { get; set; }
    ...
    public string user_type_schema_name { get; set; } = string.Empty;
    public int? user_type_is_nullable { get; set; }
    public string base_type_name { get; set; } = string.Empty;
}

internal sealed class FunctionColumnRow
{
    public int object_id { get; set; }
    public int ordinal { get; set; }
