...
public class AppDbContext(
    ...
    IOptions<AppDbContextOptions>? options = null
) : IAppDbContext, IDisposable
{
    public AppDbContextOptions Options { get; } = options?.Value ?? new AppDbContextOptions();
    public SqlConnection Connection { get; } = new SqlConnection(configuration.GetConnectionString("<spocr>DefaultConnection</spocr>"));
    public List<SqlTransaction> Transactions { get; } = new List<SqlTransaction>();
