...
public static class UserDefinedTypeQueries
{
    /// <summary>
    /// Liefert alle benutzerdefinierten skalaren Typen (keine Table Types) inklusive Basis-Typ Zuordnung.
    /// </summary>
...
public class UserDefinedTypeRow
{
