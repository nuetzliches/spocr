...
ORDER BY s.name, o.name;";
    ...
    {
    const string sql = @"SELECT p.object_id, p.parameter_id AS ordinal, p.name AS param_name, t.name AS system_type_name, p.max_length,
...
ORDER BY p.object_id, p.parameter_id;";
    ...
    {
    const string sql = @"SELECT c.object_id, c.column_id AS ordinal, c.name AS column_name, t.name AS system_type_name,
...
public class FunctionParamRow { public int object_id { get; set; } public int ordinal { get; set; } public string param_name { get; set; } public string system_type_name { get; set; } public int max_length { get; set; } public int normalized_length { get; set; } public int is_output { get; set; } public int is_nullable { get; set; } public int has_default_value { get; set; } }
public class FunctionColumnRow { public int object_id { get; set; } public int ordinal { get; set; } public string column_name { get; set; } public string system_type_name { get; set; } public int is_nullable { get; set; } public int max_length { get; set; } public int normalized_length { get; set; } }
