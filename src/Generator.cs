...
namespace SpocR
{
    public class Generator
    {
        ...
        public SourceText GetModelTextForStoredProcedure(Definition.Schema schema, Definition.StoredProcedure storedProcedure)
        {
            ...
            var output = storedProcedure.Output?.ToList() ?? new List<StoredProcedureOutputModel>();
        ...
        public void GenerateDataContextOutputs(bool isDryRun)
        {
            ...
            foreach (var schema in schemas)
            {
                ...
                var dataContextOutputsPath = DirectoryUtils.GetWorkingDirectory(_configFile.Config.Project.Output.DataContext.Path, _configFile.Config.Project.Output.DataContext.Outputs.Path);
        ...
        public string GetPropertyFromSqlInputTableType(string name)
        {
