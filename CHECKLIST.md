...
- [x] TableTypes: Original Snapshot Namen vollständig beibehalten (nur Sanitizing) – keine erzwungene \*TableType Suffix Ergänzung
      ...
      - [ ] Gemeinsames Header-Template (`_Header.spt`) mit `// <auto-generated/>` + Hinweis Bridge Phase v4.5
      - [ ] Alle bestehenden Templates nutzen Header-Include (oder Prepend im Generator falls Include noch nicht unterstützt)
      - [ ] Entscheidung Timestamp: verbleibt nur in `<remarks>` Zeilen; nicht im Header (Hash-stabil)

      Erweiterte Generatoren (E014)
      - [ ] Template + Generator: Inputs (Parameter-DTOs / Value Objects)
      - [ ] Template + Generator: Outputs (DTO/Records)
