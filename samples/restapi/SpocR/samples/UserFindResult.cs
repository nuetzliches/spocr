...
/// <summary>
/// Result model for samples.UserFind (Success + optional payload)
/// </summary>
public readonly record struct UserFindResult(bool Success, string? Error, SamplesUserFindResultSet1Row? Value);
