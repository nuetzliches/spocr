...
internal static partial class CreateUserWithOutputPlan
{
    ...
    {
		var list = new System.Collections.Generic.List<object>(); int o0=ReaderUtil.TryGetOrdinal(r, "CreatedUserId"); while (await r.ReadAsync(ct).ConfigureAwait(false)) { list.Add(new CreateUserWithOutputResultSet1Result(o0 < 0 ? default(int) : r.GetInt32(o0))); } return list;
    }),
